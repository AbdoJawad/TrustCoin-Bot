...
def run_flask():
    ...
    port = int(os.getenv('PORT', 8445))  # Different port for French bot
...
def main() -> None:
    ...
    try:
        ...
        flask_thread.start()
        logging.info("Flask server started on port " + str(os.getenv('PORT', 8445)))
        
        if webhook_url:
            # Production mode with webhook
            logging.info("Starting French bot in webhook mode...")
